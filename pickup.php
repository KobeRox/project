...
//get all the data from now 2 hours and also unassigned

$sql="SELECT * FROM booking WHERE status = 'unassigned' && combined BETWEEN CURRENT_TIMESTAMP AND DATE_ADD(CURRENT_TIMESTAMP , INTERVAL 2 HOUR ); ";
